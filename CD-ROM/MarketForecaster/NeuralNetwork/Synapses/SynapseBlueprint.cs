namespace NeuralNetwork.Synapses
{
    ...
    public class SynapseBlueprint
    {
        ...
        /// </summary>
        /// 
        /// <param name="sourceNeuronIndex">The index of the source neuron (within the source layer).</param>
        /// <param name="targetNeuronIndex">The index of the target neuron (within the target layer).</param>
